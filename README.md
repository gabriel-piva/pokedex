...
Ao clicar em um Pokemon é possível ver sua própria página com suas estatísticas, além de poder adicioná-lo à sua equipe, que pode ter até 6 Pokemon.
...
### Objetivo
O projeto tinha como objetivo principal o estudo e prática de HTML, CSS e JavaScript, focando na construção de uma aplicação responsiva, na utilização de uma API e na construção das separações e dos filtros de busca e tipo aplicados nas consultas.
